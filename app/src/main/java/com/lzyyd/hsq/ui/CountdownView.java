...
public class CountdownView extends View {
    ...
    private static final float DEFAULT_SUFFIX_LR_MARGIN = 0; // dp
    ...
    public CountdownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTimeBgColor = ta.getColor(R.styleable.CountdownView1_timeBgColor, 0x00444444);
        mTimeBgRadius = ta.getDimension(R.styleable.CountdownView1_timeBgRadius, 0);
        isShowTimeBgDivisionLine = ta.getBoolean(R.styleable.CountdownView1_isShowTimeBgDivisionLine, false);
        ...
        isHideTimeBackground = ta.getBoolean(R.styleable.CountdownView1_isHideTimeBackground, false);
        ...
        mSuffixTextColor = ta.getColor(R.styleable.CountdownView1_suffixTextColor, 0xFFffffff);
        ...
        mSuffixLRMargin = ta.getDimension(R.styleable.CountdownView1_suffixLRMargin, 0);
        mSuffixDayLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixDayLeftMargin, 0);
        mSuffixDayRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixDayRightMargin, 0);
        mSuffixHourLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixHourLeftMargin, 0);
        mSuffixHourRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixHourRightMargin, 0);
        mSuffixMinuteLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixMinuteLeftMargin, 0);
        mSuffixMinuteRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixMinuteRightMargin, 0);
        mSuffixSecondLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixSecondLeftMargin, 0);
        mSuffixSecondRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixSecondRightMargin, 0);
        mSuffixMillisecondLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixMillisecondLeftMargin, 0);
        ta.recycle();
